 ...
 */
public class FragmentTechnicalProblems extends Fragment {
    String mContentType;
    TextView txtTitle, txtText, txtPhone, txtEmail;
    Button btnPhone, btnEmail;
    private Tracker mTracker;

    public FragmentTechnicalProblems() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.screen_technical_problems, container, false);
        ((MainActivity)getActivity()).setTitle(getResources().getString(R.string.technical_problems));
        ...
        txtEmail = (TextView) rootView.findViewById(R.id.txtOrEmailScreenTechnicalProblems);
        txtPhone = (TextView) rootView.findViewById(R.id.txtPhoneNumberScreenTechnicalProblems);
        txtTitle = (TextView) rootView.findViewById(R.id.txtTitleScreenTechnicalProblems);
        txtText = (TextView) rootView.findViewById(R.id.txtTextScreenTechnicalProblems);

        btnEmail = (Button) rootView.findViewById(R.id.btnEmailScreenTechnicalProblems);
        btnPhone = (Button) rootView.findViewById(R.id.btnPhoneScreenTechnicalProblems);
        ...
        mTracker.setScreenName("Customer Support Technical");
