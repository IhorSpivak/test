...
/**
 * Created by gorf on 5/6/17.
 */
public class FragmentCheckoutBorderShop extends Fragment {
...
//    Button btnDiscount;
    ...
    LinearLayout flightLayout, storeLayout;
    ...
    public FragmentCheckoutBorderShop() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTracker.setScreenName("Checkout bordershop");
...
//        FontUtils.setNormalFont(getContext(), btnAirport);
        flightLayout = (LinearLayout)rootView.findViewById(R.id.linearLayoutFlightSelectScreenCheckout);
        flightLayout.setVisibility(View.GONE);
        storeLayout = (LinearLayout)rootView.findViewById(R.id.linearLayoutAirportSelectScreenCheckout);
...
//        FontUtils.setNormalFont(getContext(), btnFlight);
        btnEnterFlightManually.setVisibility(View.GONE);
        btnFlight.setVisibility(View.GONE);
...
//        FontUtils.setNormalFont(getContext(), edtFlight);
        edtFlight.setVisibility(View.GONE);
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isValid()) {
                    ...
                    ((FragmentConfirm) fragment).setAirport(MDFApplication.getMDFApplication().getAirport());
                    ((FragmentConfirm) fragment).setThankType(ThankPageType.THANK_TYPE_BORDERSHOP);
