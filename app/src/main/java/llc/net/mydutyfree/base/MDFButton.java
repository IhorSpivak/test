 ...
 */
public class MDFButton extends Button {
    String mText = "";
    Paint mTextPaint;
    ...
    public MDFButton(Context context) {
        super(context);
        init();
    }

    public MDFButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseAttrs(attrs);
        init();
    }

    public MDFButton(Context context, AttributeSet attrs, int defStyle) {
